#-*- coding:utf-8 -*-
'''
程序说明（Introduce）：多层神经网络简单实现，来自 theano 教程。
引用（References）：http://deeplearning.net/tutorial/mlp.html
创建时间：’2015/8/7 21:03'
编写与修改：
            ...
            if (iter + 1) % validation_frequency == 0:
                ...
                if this_validation_loss < best_validation_loss:
                    ...
                    if(
                        ...
                        patience = max(patience, iter*patience_incresase)
